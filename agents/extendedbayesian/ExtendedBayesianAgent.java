...
/**
 * ExtendedBayesianAgent extends the BayesianAgent class in that a larger hypothesesSpace is
 * used to predict the opponents preference.
 * 
 * @author Mees
 */
public class ExtendedBayesianAgent extends AbstractAgent {
	...
	public void init() {
		try {
			...
			predictor = new ExtendedBayesianPredictor(utilitySpace.getDomain().getIssues(), agentEvaluationAim);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public String getName() {
		return "Extended Bayesian Agent";
	}
