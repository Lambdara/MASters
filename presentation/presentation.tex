...
\begin{document}
	...
	\frame{
		...
		One paper described an agent which tries to estimate its opponents preferences. Given this information one can create an offer that, given a certain utility for yourself, is as good as you can make it for the other, motivating them to accept.
		We modified the algorithm to work in our context.
		\end{block}
	}
	\frame{
		\frametitle{Our Project}
