...
\begin{document}
	...
	\frame{
		\frametitle{Our Project}
		\framesubtitle{Our Agents - part 1}
	...
	\frame{
		...
		\begin{block}{3 types}
		\begin{itemize}
		\item Boulware Bayesian
		\item Normal Bayesian
		\item Uniform Bayesian
		\end{itemize}
	...
	\frame{
		...
		\begin{block}{SD Analyzer Agent}
		\begin{itemize}
		\item Update opponent's preferences using standard deviation.
		\item Create counter-offers based on these preferences
		\item Uses boulware.
		\end{itemize}		
		\end{block}
	}
	...
	\frame {
		\includegraphics[scale=0.35]{results2}
	}	
